...
const Project = () => {
  ...
  return (
    <section id="portfolio" className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
      <motion.div 
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
