              ...
              >
                <div className="relative h-52 overflow-hidden">
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/60 to-transparent flex items-end p-6">
                    <p className="text-white text-lg font-semibold leading-snug px-5 py-3 rounded-xl bg-black/50 backdrop-blur-md border border-white/30">
                      {project.description}
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="h-44 overflow-hidden relative">
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/60 to-transparent flex items-end p-6"></div>
              </div>
