  ...
  const socialLinks = [
    {
      ...
      color:
        'hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:border-blue-200 dark:hover:border-blue-700',
        ...
        <div className="flex flex-col  lg:flex-row items-center gap-12 lg:gap-16 xl:gap-20">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="typed-container flex flex-wrap items-center gap-3 font-bold">
                  ...
                  <ReactTyped
                    className="text-transparent text-ipod-air bg-clip-text bg-linear-to-r 
             from-purple-500 via-pink-500 to-rose-500 min-w-[280px]"
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl text-center lg:text-left">
                Ich entwickle außergewöhnliche digitale Erlebnisse mit modernen
                Webtechnologien und liefere{' '}
          ...
          <div className="w-full lg:w-1/2 flex justify-center order-1 lg:order-2 relative pt-10 lg:pt-0">
            <div className="relative w-80 h-80 md:w-96 md:h-96 lg:w-[500px] lg:h-[500px] xl:w-[560px] xl:h-[560px] group">
              ...
              <div
                className="relative w-full h-full lg:pt-0  overflow-hidden  rounded-full
              ...
              <div
                className="absolute -inset-4 rounded-3xl bg-linear-to-r from-sky-500/30 via-blue-500/30 to-cyan-500/30 
                            opacity-0 group-hover:opacity-100 blur-2xl transition-all duration-500 pointer-events-none"
              ></div>

              {/* Floating Elements */}
              <div
                className="absolute -top-4 -right-4 w-8 h-8 bg-cyan-400 rounded-full opacity-0 group-hover:opacity-100 
                            animate-bounce delay-300 transition-opacity duration-500"
              ></div>
              <div
                className="absolute -bottom-4 -left-4 w-6 h-6 bg-sky-400 rounded-full opacity-0 group-hover:opacity-100 
                            animate-bounce delay-500 transition-opacity duration-500"
              ></div>
            </div>
          </div>
        </div>
