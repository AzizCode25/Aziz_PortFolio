...
const Home = () => {
  ...
  return ( 
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-10 md:py-20 lg:pt-0 lg:pb-0">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-linear-to-br from-sky-200 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-sky-900/20"></div>
          ...
          <div className="w-full lg:w-1/2 space-y-8 order-2 lg:order-1">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap items-center gap-3 text-3xl md:text-4xl lg:text-5xl font-bold">
                  <span className="text-gray-700 dark:text-gray-300">A</span>
                  <ReactTyped
                    className="text-transparent bg-clip-text bg-linear-to-r from-purple-500 via-pink-500 to-rose-500 min-w-[280px]"
                    strings={[
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <a 
                href="#contact" 
                className="group px-10 py-4 border-2 border-sky-500 text-sky-600 dark:text-sky-400 font-semibold rounded-2xl 
